...
export const config = {
  ...
  obsidianSyncEnabled: asBoolean(process.env.OBSIDIAN_SYNC_ENABLED, Boolean(process.env.OBSIDIAN_GITHUB_REPO)),
  obsidianGithubToken: process.env.OBSIDIAN_GITHUB_TOKEN || process.env.GITHUB_BACKUP_TOKEN || "",
  obsidianGithubRepo: process.env.OBSIDIAN_GITHUB_REPO || "",
