...
export const config = {
  ...
  investmentReportReuseMaxAgeMinutes: asNumber(process.env.INVESTMENT_REPORT_REUSE_MAX_AGE_MINUTES, 720),
  wechatMpEnabled: asBoolean(process.env.WECHAT_MP_ENABLED, Boolean(process.env.WECHAT_MP_APP_ID && process.env.WECHAT_MP_APP_SECRET)),
  wechatMpAppId: process.env.WECHAT_MP_APP_ID || "",
  wechatMpAppSecret: process.env.WECHAT_MP_APP_SECRET || "",
  wechatMpAuthor: process.env.WECHAT_MP_AUTHOR || process.env.BOT_DISPLAY_NAME || "",
  wechatMpDefaultThumbMediaId: process.env.WECHAT_MP_DEFAULT_THUMB_MEDIA_ID || "",
  wechatMpCtaText: process.env.WECHAT_MP_CTA_TEXT || "",
  wechatMpAiTimeoutMs: asNumber(process.env.WECHAT_MP_AI_TIMEOUT_MS, 60000),
  wechatMpOpenComment: asBoolean(process.env.WECHAT_MP_OPEN_COMMENT, false),
  ...
  feishuInvestmentReportParentWikiToken: process.env.FEISHU_INVESTMENT_REPORT_PARENT_WIKI_TOKEN || process.env.FEISHU_RESEARCH_REPORT_PARENT_WIKI_TOKEN || "",
